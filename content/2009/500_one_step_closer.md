...
So I discovered that Guitar Pro 5 "works" with wine (after installing Kubuntu 64 09.04).  I say "works" because the MIDI part doesn't (though there are lots of guides to wrap timidiy around wine), but GP5 uses RSE (real sound engine I think), so some of the instruments don't use MIDI.  It's close enough to practice against.
