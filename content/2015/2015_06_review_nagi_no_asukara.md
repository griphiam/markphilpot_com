...
The first OP set the stage well. *Lull* matches the initial innocence of the world and characters as we start on this journey.  The second OP however was easily my favorite.
...
*Ebb & Flow* perfectly sets up where these characters have made it to and where they are going.
...
It took me longer to finish this that it should have -- 26 episodes is really a lot when current shows are usually given only a single cour. If you're interested, here's the [graph]({filename}/images/2015/nagi_no_asukara/final.png) on how everyone ended up.
