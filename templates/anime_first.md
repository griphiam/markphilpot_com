...
![{{ show.title_romaji }}]({filename}/images/anime/{{ year }}/{{ season }}/{{ show.**pv_filename** }} "{{ show.title_romaji }}"){: .center} ![{% for studio in show.__page__.studio %}{{ studio.studio_name }}, {% endfor %}]({filename}/images/anime/studios/half/.png){: .studio}
